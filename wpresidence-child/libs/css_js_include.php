...
function wpestate_scripts() {   
    ...
    //wp_enqueue_style('wpestate_custom_code',get_template_directory_uri().'/style.css.php', array(), '1.0', 'all'); 
    ...
    wp_enqueue_script('jslick.min', get_template_directory_uri().'/js/slick.min.js',array('jquery'), '1.0', true);
    ...
    if($header_type==5 || $global_header_type==4 || is_page_template('user_dashboard_add.php') || is_single() || is_page_template('add_property.php')){    
   ...
   $measure_sys             = get_option('wp_estate_measure_sys','');
    ...
    if(is_page_template('user_dashboard_add.php') || is_page_template('user-dashboard.php') || is_page_template('add_property.php')){
            $page_lat   = esc_html( get_option('wp_estate_general_latitude','') );
            $page_long  = esc_html( get_option('wp_estate_general_longitude','') );
