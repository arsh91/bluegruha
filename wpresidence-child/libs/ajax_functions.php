...
if( !function_exists('wpestate_register_as_user') ):
    function  wpestate_register_as_user($user_name,$user_id,$first_name='',$last_name='',$flag='',$gender='',$locale='',$timezone=''){
        $post = array(
        ...
        update_post_meta($post_id, 'user_meta_id', $user_id);
		...
		if($flag != '' && $flag == 1){
			update_user_meta( $user_id, 'source' , 'Google') ; 
		}else if($flag != '' && $flag == 2){
			update_user_meta( $user_id, 'source' , 'Facebook') ; 
		}
     }
 endif;
////////////////////////////////////////////////////////////////////////////////
                          ...
                          <button id="wp-login-but" class="wpresidence_button">'.__('Login','wpestate').'</button>
                                ...
                                <a href="#" id="reveal_register">'.__('Don\'t have an account? Register here!','wpestate').'</a>';
                                    ...
                                    if($facebook_status=='yes'){
                                        print '<div id="facebooklogin" data-social="facebook">'.__('Login with Facebook','wpestate').'</div>';
                                    }
                                    if($google_status=='yes'){
                                        print '<div id="googlelogin" data-social="google">'.__('Login with Google','wpestate').'</div>';
                                    }
                                    if($yahoo_status=='yes'){
                                        print '<div id="yahoologin" data-social="yahoo">'.__('Login with Yahoo','wpestate').'</div>';
                                    }
