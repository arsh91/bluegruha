...
function savePropertyToRent(){
    ...
    //    $property_state                 =   wp_kses( $_POST['property_state'],$allowed_html);
		...
		if($post_id) {
			...
			$property_type                 	=   wp_kses( esc_html($_POST['property_type']),$allowed_html);
			$area                 			=   wp_kses( esc_html($_POST['area']),$allowed_html);
			$bedrooms                 		=   wp_kses( esc_html($_POST['bedrooms']),$allowed_html);
